...
crate0 addWeaponCargoGlobal ["vn_m60", 1]; // M60
...
crate0 addItemCargoGlobal ["vn_b_vest_sas_03", 1]; // SAS Vest MG
...
crate1 addWeaponCargoGlobal ["vn_m16_camo", 1]; // M16 Camo
crate1 addItemCargoGlobal ["vn_o_4x_m16", 1]; // M16 4x Scope
crate1 addItemCargoGlobal ["vn_s_m16", 1]; // M16 Silencer
crate1 addWeaponCargoGlobal ["vn_hp", 1]; // HP Automatic
crate1 addWeaponCargoGlobal ["vn_m72", 1]; // M72 LAW
crate1 addWeaponCargoGlobal ["vn_m20a1b1_01", 1]; // Super Bazooka
...
crate1 addItemCargoGlobal ["vn_b_helmet_m1_10_01", 1]; // M1 Helmet
crate1 addItemCargoGlobal ["vn_b_vest_seal_05", 1]; // Vest SEAL Scout
crate1 addBackpackCargoGlobal ["vn_b_pack_prc77_01", 1]; // SOG Army RTO Pack
crate1 addBackpackCargoGlobal ["vn_b_pack_trp_04", 1]; // SOG Tropical RTO
...
crate1 addItemCargoGlobal ["vn_mine_m112_remote_mag", 5]; // M112 Breaching Charge
...
crate4 addWeaponCargoGlobal ["uns_357m", 1]; // Colt Lawman MKIII
crate4 addItemCargoGlobal ["vn_b_helmet_aph6_01_04", 1]; // APH6 Helmet USN VA196
crate4 addItemCargoGlobal ["vn_c_headband_01", 1]; // Red Headband
...
crate4 addItemCargoGlobal ["ACE_M26_Clacker", 1]; // M152 Firing Device
...
crate6 addWeaponCargoGlobal ["vn_m63a_cdo", 1]; // M63A Commando
crate6 addWeaponCargoGlobal ["vn_mx991_m1911", 1]; // M1911 Flashlight
crate6 addWeaponCargoGlobal ["vn_m72", 1]; // M72 LAW
crate6 addWeaponCargoGlobal ["vn_m20a1b1_01", 1]; // Super Bazooka
...
crate6 addItemCargoGlobal ["U_Simc_TCU_mk3_mc", 1]; // TCF 1967
...
crate7 addWeaponCargoGlobal ["vn_m79", 1]; // M79 40mm GL
...
crate7 addBackpackCargoGlobal ["B_simc_rajio_Frem_2", 1]; // ANPRC25 Rucsack
...
crate7 addItemCargoGlobal ["V_Simc_flak_55_mk2_morser", 1]; // M1955 Vest LCE Mortar
...
crate8 addItemCargoGlobal ["vn_b_uniform_macv_05_15", 1]; // BDU MACV5 ERDL
crate8 addBackpackCargoGlobal ["vn_b_pack_lw_07", 1]; // Pack - Army Medic
crate8 addBackpackCargoGlobal ["vn_b_pack_trp_04", 1]; // SOG Tropical RTO
...
crate10 addWeaponCargoGlobal ["vn_m20a1b1_01", 1]; // Super Bazooka
...
crate12 addWeaponCargoGlobal ["vn_m20a1b1_01", 1]; // Super Bazooka
...
crate12 addItemCargoGlobal ["vn_b_uniform_k2b_01_04", 1]; // Jet Crew Tiger
...
crate15 addWeaponCargoGlobal ["vn_m20a1b1_01", 1]; // Super Bazooka
...
crate17 addWeaponCargoGlobal ["vn_m14_camo", 1]; // M14 Camo
crate17 addItemCargoGlobal ["vn_o_9x_m14", 1]; // M14 Scope
crate17 addItemCargoGlobal ["vn_s_m14", 1]; // M14 suppressor
crate17 addItemCargoGlobal ["vn_b_camo_m14", 1]; // M14 camo wrap
crate17 addWeaponCargoGlobal ["vn_m79", 1]; // M79 GL
...
crate17 addWeaponCargoGlobal ["vn_m20a1b1_01", 1]; // Super Bazooka
crate17 addItemCargoGlobal ["H_Simc_M1_g3", 1]; // SS M1 Helmet (Graffiti)
crate17 addItemCargoGlobal ["vn_b_boonie_01_03", 1]; // Boonie F Sides Black
crate17 addItemCargoGlobal ["vn_o_bandana_b", 1]; // bandana Black
...
crate17 addItemCargoGlobal ["vn_b_uniform_sog_02_03", 1]; // BDU SOG 2 Black
...
crate17 addBackpackCargoGlobal ["vn_b_pack_trp_04", 1]; // Pack SOG Tropical RTO
crate17 addItemCargoGlobal ["V_Simc_flak_M69_med", 1]; // 3/4 Collar Vest LCE Medic
crate17 addItemCargoGlobal ["vn_b_vest_sog_04", 1]; // Vest SOG Scout

// Crate 18 - Decoy ************************************************************************

crate18 addWeaponCargoGlobal ["vn_m1_garand", 1]; // M1 Garand
crate18 addWeaponCargoGlobal ["vn_l1a1_01", 1]; // L1A1 AUS
crate18 addWeaponCargoGlobal ["vn_m16_camo", 1]; // M16 Camo
crate18 addItemCargoGlobal ["vn_o_4x_m16", 1]; // M16 4x Scope
crate18 addItemCargoGlobal ["vn_s_m16", 1]; // M16 Silencer
crate18 addItemCargoGlobal ["vn_b_uniform_macv_01_07", 1]; // SOG BDU MACV1 (Olive)
crate18 addItemCargoGlobal ["vn_b_uniform_macv_01_02", 1]; // BDU MACV1 Tiger
...
crate18 addItemCargoGlobal ["V_Simc_flak_55_mk2_belt", 1]; // M1955 Vest
crate18 addBackpackCargoGlobal ["B_simc_US_asspack_56", 1]; // 1956 Buttpack
crate18 addBackpackCargoGlobal ["vn_b_pack_lw_01", 1]; // Pack Army Rifleman
...
crate22 addWeaponCargoGlobal ["vn_m63a_lmg", 1]; // M63A LMG
...
crate22 addBackpackCargoGlobal ["vn_b_pack_trp_02", 1]; // SOG Pack Tropical
...
crate25 addItemCargoGlobal ["H_Simc_M1C_bitch_b9", 1]; // M1C Helmet
crate25 addBackpackCargoGlobal ["uns_simc_pack_frem_1_alt", 1]; // Lightweight Rucksack
crate25 addItemCargoGlobal ["vn_b_bandana_a", 1]; // Bandana Aviators
crate25 addItemCargoGlobal ["uns_simc_56", 1]; // M1856 LCE
crate25 addItemCargoGlobal ["vn_b_item_radio_urc10", 1]; // SR Radio
crate25 addItemCargoGlobal ["ACE_personalAidKit", 1]; // PAK 
crate25 addItemCargoGlobal ["ACE_EntrenchingTool", 1]; // Entrenching Tool